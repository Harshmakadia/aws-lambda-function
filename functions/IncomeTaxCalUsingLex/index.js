...
function makeAppointment(intentRequest, callback) {
    console.log('IncomeTax intent');
    const taxtype = intentRequest.currentIntent.slots.taxtype;
    const gender = intentRequest.currentIntent.slots.gender;
    const residenttype = intentRequest.currentIntent.slots.residenttype;
    const amount = intentRequest.currentIntent.slots.amount;

    console.log("Slot value",taxtype,gender,residenttype,amount);
    ...
    helper.calculateData201819Yr("2018-19", taxtype, gender, amount, residenttype, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined,function (incometaxobj) {
        callback(close(outputSessionAttributes, 'Fulfilled', { contentType: 'PlainText',
            content: `Okay, I have calculated the Tax for you\n.  IncomeTax - ${incometaxobj.IncomeTax}\n,  Surcharge - ${incometaxobj.Surcharge}\n EducationCess - ${incometaxobj.EducationCess}\n SecondaryHigherCess - ${incometaxobj.SecondaryHigherCess}\n TotalTaxLiability - ${incometaxobj.TotalTaxLiability}\n`}));
    });
